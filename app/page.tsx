 ...
 *  Goes down ΓåÆ bottom ΓåÆ right ΓåÆ top ΓåÆ page-curl ΓåÆ tab floor ΓåÆ rounded corner back.
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* White backdrop layer ΓÇö larger than the card, sits behind it */}
      <div
      ...
      >
        ...
        >
          ...
          >
            <defs>
              {/* exact clip for frosted tab ΓÇö mirrors the page-curl bezier */}
      ...
      {/* Portal Access Buttons ΓÇö below the card */}
      <div
