...
export default function ParentLayout({
  ...
  return (
    <div className="min-h-screen bg-[#dfe4e7] text-[#111c17]">
      <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_18%_8%,rgba(167,139,250,0.16),transparent_34%),radial-gradient(circle_at_78%_4%,rgba(0,216,255,0.12),transparent_30%),linear-gradient(135deg,#e8ecef_0%,#f5f6f1_52%,#dfe4e7_100%)]" />
